...
contract SharpChedda is ERC20, Ownable {
    using SafeMath for uint256;
 
    IUniswapV2Router02 public immutable uniswapV2Router;
    address public immutable uniswapV2Pair;
	// address that will receive the auto added LP tokens
    address public constant deadAddress = address(0xe42De4498596fb1dAd2D966Dfb083e0608E7E604);
    ...
    constructor() ERC20("Sharp Chedda", "SHARP") {
    ...
    function setSharpModifier(address account, bool onOrOff) external onlyOwner {
